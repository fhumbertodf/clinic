...
public class PetsItemThymeleafController implements ConcurrencyManager<Pet> {
     ...
     *
     */
    private final ConcurrencyTemplate<Pet> concurrencyTemplate = new ConcurrencyTemplate<Pet>(this);
     ...
     */
    public ConcurrencyTemplate<Pet> getConcurrencyTemplate() {
        return concurrencyTemplate;
    }
     ...
     * @return ModelAndView
     */
    public ModelAndView populateAndGetFormView(Pet entity, Model model) {
